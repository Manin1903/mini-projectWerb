          ...
          <div className="mr-auto place-self-center lg:col-span-8">
            ...
            <form action="#">
                <div className="grid gap-4 mb-4 sm:grid-cols-2 w-full">
                    ...
                    <button type="submit" class="text-white bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:outline-none w-32 mt-5  focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                       Sign Up
                    </button>
